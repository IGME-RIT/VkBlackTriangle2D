...
void Demo::prepare_pipeline()
{
	...
	// Vertex Input State
	// We are not using a vertex buffer (that comes later),
	...
	// drawing a triangle), try VK_CULL_MODE_NONE_BIT.
	...
	// we have a 2D triangle, so we give the required sTYpe,
	// and we move on
	...
	// and Fragment shaders into two files: triangle.vert and triangle.frag.
	...
	// First, it compiles the GLSL files triangle.vert and triangle.frag into
	...
	// you can use triangle2.vert.spv and triangle2.frag.spv. However,
...
void Demo::build_swapchain_cmds()
{
	...
	for (uint32_t i = 0; i < swapchainImageCount; i++)
	{
		...
		// Draw the triangle
		// We have three vertices, and we draw
		// this triangle 1 time. The vertices
		// of the triangle will be determined in the
		// triangle.vert shader
